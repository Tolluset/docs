...
- Add the line `classpath 'com.amplifyframework:amplify-tools-gradle-plugin:1.0.1'` within the `dependencies` blocks in both `buildscript` and `allprojects` blocks
